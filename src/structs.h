...
/* CWG Version String */
#define CWG_VERSION "CWG Doom - 3.X.XX"
...
#define ROOM_WORLDMAP     	20  /* World-map style maps here */
...
#define CLASS_ARCANE_ARCHER     11
#define CLASS_ARCANE_TRICKSTER  12
#define CLASS_ARCHMAGE          13
...
#define NUM_NPC_CLASSES 	5
#define NUM_PRESTIGE_CLASSES	15
#define NUM_BASIC_CLASSES	((NUM_CLASSES - NUM_NPC_CLASSES) - NUM_PRESTIGE_CLASSES)
...
#define PRF_AUTOMAP	38 /* Show map at the side of room descs 	*/	

#define NUM_PRF_FLAGS   39
...
#define AFF_STRIKE_STUNNING   40   /* Char is using stunning fist */

#define NUM_AFF_FLAGS 41
...
#define CON_HEDIT        37     /* OLC mode - help edit                 */

#define NUM_CON_TYPES 38
...
#define APPLY_UNUSED0	       20	/* Unused			*/
#define APPLY_UNUSED1	       21	/* Unused			*/
#define APPLY_UNUSED2	       22	/* Unused			*/
...
#define MAX_ASSM    	        11
#define NUM_FULLNESS		3
#define NUM_WEEK_DAYS		6
...
#define VAL_WINDOW_VEHICLE_VNUM       0
...
struct player_special_data {
  ...
  cl_uint8 screen_width;	/* How wide a players page is		*/
...
struct affected_type {
   ...
   cl_sint16 sktype;      /* What kind of skill/spell/feat is type? */
...
struct char_data {
  ...
  cl_sint16 armor;		/* Internally stored *10		*/
