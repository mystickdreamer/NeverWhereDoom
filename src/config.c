...
CVSHEADER("$CVSHeader: cwg/rasputin/src/config.c,v 1.5 2004/12/23 22:37:02 fnord Exp $");
...
/* Autowipe deletion criteria
   ...
   * Element 7: Because -1 is less than 30, this is assumed to
	...
	case.
*/
struct pclean_criteria_data pclean_criteria[7] = {
/*	LEVEL		DAYS	*/
  {	0		,0	}, /* level 0 */
  {	1		,30	},
  {	4		,90	},
