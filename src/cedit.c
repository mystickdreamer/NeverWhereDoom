...
CVSHEADER("$CVSHeader: cwg/rasputin/src/cedit.c,v 1.7 2004/12/30 19:06:03 fnord Exp $");
...
void cedit_disp_game_play_options(struct descriptor_data *d)
{
  ...
  write_to_output(d, "\r\n\r\n"
        ...
        "@WU@B) @CMap/Automap Option          : @c%s\r\n"
        "@WV@B) @CDefault map size            : @c%d\r\n"
        "@WW@B) @CDefault minimap size        : @c%d\r\n"
